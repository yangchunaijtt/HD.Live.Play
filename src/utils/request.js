...
import { showApiLoading, hideApiLoading } from './api-loading'

// create an axios instance
const service = axios.create({
  baseURL: process.env.VUE_APP_BASE_API, // url = base url + request url  process.env.NODE_ENV === 'production' ? '/App' :
