...
const name = 'HD.TS.Center' // page title
...
module.exports = {
  ...
  outputDir: process.env.VUE_APP_TITLE === 'build2' ? process.env.OUT_PUT_DIR2 : process.env.OUT_PUT_DIR, // 'dist'
  assetsDir: 'static',
  ...
  devServer: {
    ...
    proxy: {
      [process.env.VUE_APP_BASE_API]: {
        target: process.env.VUE_APP_TITLE === 'build2' ? process.env.API_TARGET2 : process.env.API_TARGET,
        changeOrigin: true,
        pathRewrite: {
          ['^' + process.env.VUE_APP_BASE_API]: ''
        }
